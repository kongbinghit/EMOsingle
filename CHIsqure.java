...
public class CHIsqure {
	...
	public static List setWords;
	public static List setSentences;
	...
	public static void main(String[] args) {
		...
		try {
			...
			BufferedReader reader = new BufferedReader(new FileReader(new File(
					"C:/Users/lin/Desktop/myemotion/bigram.data")));
			String tempString;
			...
			BufferedReader reader2 = new BufferedReader(
					new FileReader(
							new File(
									"C:/Users/lin/Desktop/myemotion/trainData4000-weight.xml")));
			int num = 0;
	...
	private static void calc() {
		String[] classes = { "none", "happiness", "like", "anger", "fear",
...
//		String[] classes = {"surprise"};
		...
		try {
			OutputStreamWriter w1 = new OutputStreamWriter(
					new FileOutputStream("C:/Users/lin/Desktop/myemotion/classCHI/bigramnone.csv"), "UTF-8");
			OutputStreamWriter w2 = new OutputStreamWriter(
					new FileOutputStream("C:/Users/lin/Desktop/myemotion/classCHI/bigramhappiness.csv"), "UTF-8");
			OutputStreamWriter w3 = new OutputStreamWriter(
					new FileOutputStream("C:/Users/lin/Desktop/myemotion/classCHI/bigramlike.csv"), "UTF-8");
			OutputStreamWriter w4 = new OutputStreamWriter(
					new FileOutputStream("C:/Users/lin/Desktop/myemotion/classCHI/bigramanger.csv"), "UTF-8");
			OutputStreamWriter w5 = new OutputStreamWriter(
					new FileOutputStream("C:/Users/lin/Desktop/myemotion/classCHI/bigramfear.csv"), "UTF-8");
			OutputStreamWriter w6 = new OutputStreamWriter(
					new FileOutputStream("C:/Users/lin/Desktop/myemotion/classCHI/bigramsadness.csv"), "UTF-8");
			OutputStreamWriter w7 = new OutputStreamWriter(
					new FileOutputStream("C:/Users/lin/Desktop/myemotion/classCHI/bigramdisgust.csv"), "UTF-8");
			OutputStreamWriter w8 = new OutputStreamWriter(
					new FileOutputStream("C:/Users/lin/Desktop/myemotion/classCHI/bigramsurprise.csv"), "UTF-8");
...
//							+ "      " + word + "和" + classs + "的卡方为" + chi);
			...
			w1.write(map.get("none").toString().replaceAll("NaN", "0"));
